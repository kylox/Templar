    ...
    public static class cursor
    {
       ...
       static Vector2 deplacement= new Vector2(0, 0);
        ...
        public static void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(ressource.pixel, new Rectangle((int)position.X, (int)position.Y + 32, 34, 2), Color.Red);
            spriteBatch.Draw(ressource.pixel, new Rectangle((int)position.X + 32, (int)position.Y, 2, 34), Color.Red);
        }
