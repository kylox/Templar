    ...
    abstract class Personnage
    {
        ...
        public void animate()
        {
            ...
            if (this.timer == this.animaitonspeed)
            {
                ...
                if (this.Framecolumn > this.nb_Framecolumn + 1)
                {
        ...
        {
            spritbatch.Draw(Image, position, new Rectangle((this.Framecolumn - 1) * this.Taille_image_x, (this.FrameLine - 1) * this.Taille_image_y, this.Taille_image_x, this.Taille_image_y), Color.White);
        }
    }
}
